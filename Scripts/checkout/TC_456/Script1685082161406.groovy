...
if (WebUI.verifyElementClickable(findTestObject('OPCPage/promoCombo1_popup_OPC (1)'), FailureHandling.OPTIONAL) == 
true) {
    i++
}

if (WebUI.verifyElementClickable(findTestObject('OPCPage/promoCombo2_popup_OPC (1)'), FailureHandling.OPTIONAL) == 
true) {
    i++
} else {
    WebUI.enhancedClick(findTestObject('OPCPage/promoCombo1_popup_OPC (1)'))
}

if (WebUI.verifyElementClickable(findTestObject('OPCPage/promoCombo3_popup_OPC (1)'), FailureHandling.OPTIONAL) == 
true) {
    i++
} else {
...
if (WebUI.verifyElementClickable(findTestObject('OPCPage/promoCombo4_popup_OPC (1)'), FailureHandling.OPTIONAL) == 
true) {
    j++
} else {
...
if (WebUI.verifyElementClickable(findTestObject('OPCPage/promoCombo5_popup_OPC (1)'), FailureHandling.OPTIONAL)) {
    j++
} else {
    WebUI.enhancedClick(findTestObject('OPCPage/promoCombo4_popup_OPC (1)'))
}
