...
WebUI.setText(findTestObject('0OPCPage/newCardNumber_OPC'), '374245001741999')

WebUI.verifyElementPresent(findTestObject('0OPCPage/img_alias_OPC'), 0)

'verify that image is of visa\r\n'
WebUI.verifyElementPresent(findTestObject('0OPCPage/card_img_americanExpress_OPC'), 0)
