...
WebUI.setText(findTestObject('OPCPage/newCardNumber_OPC'), '374245001741999')

WebUI.verifyElementPresent(findTestObject('OPCPage/img_alias_OPC'), 0)

'verify that image is of visa\r\n'
WebUI.verifyElementPresent(findTestObject('OPCPage/card_img_americanExpress_OPC'), 0)
