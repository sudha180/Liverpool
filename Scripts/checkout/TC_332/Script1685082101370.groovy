...
WebUI.click(findTestObject('OPCPage/ScrollDown_event_address_CandC_OPC (1)'))

WebUI.click(findTestObject('OPCPage/ScrollDown_event_address_CandC_option5_OPC (1)'))

WebUI.click(findTestObject('OPCPage/saveChanges_CandC_OPC (1)'))
