...
CardToSelect = WebUI.getText(findTestObject('OPCPage/card3Name_OPC'), FailureHandling.STOP_ON_FAILURE)

WebUI.enhancedClick(findTestObject('OPCPage/card3_Option_OPC'))

'to set card as default card\r\n'
WebUI.enhancedClick(findTestObject('OPCPage/option1DropDown_setDefault_card_OPC'))

'check the card had moved upward\r\n'
CardAfterSelect = WebUI.getText(findTestObject('OPCPage/card3Name_OPC'), FailureHandling.STOP_ON_FAILURE)
