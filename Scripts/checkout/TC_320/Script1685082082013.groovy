...
CardToSelect = WebUI.getText(findTestObject('0OPCPage/card3Name_OPC'), FailureHandling.STOP_ON_FAILURE)

WebUI.enhancedClick(findTestObject('0OPCPage/card3_Option_OPC'))

'to set card as default card\r\n'
WebUI.enhancedClick(findTestObject('0OPCPage/option1DropDown_setDefault_card_OPC'))

'check the card had moved upward\r\n'
CardAfterSelect = WebUI.getText(findTestObject('0OPCPage/card3Name_OPC'), FailureHandling.STOP_ON_FAILURE)
