...
WebUI.verifyElementPresent(findTestObject('0OPCPage/ShippingAddress2_Checkout'), 0)

WebUI.verifyElementPresent(findTestObject('0OPCPage/ShippingAddress1_Checkout'), 0)
