...
WebUI.verifyElementPresent(findTestObject('OPCPage/ShippingAddress2_Checkout (1)'), 0)

WebUI.verifyElementPresent(findTestObject('OPCPage/ShippingAddress1_Checkout (1)'), 0)
