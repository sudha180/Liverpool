...
WebUI.click(findTestObject('OPCPage/SelectStateClickNCollection_Checkout (1)'))

WebUI.click(findTestObject('OPCPage/StateOptionsClickNCollection_Checkout (1)'))

WebUI.click(findTestObject('OPCPage/StateSelectionClickNCollection_Checkout (1)'))
