...
WebUI.verifyElementPresent(findTestObject('HomePage/typeAheadLeftNav_hp (2)'), 0)

WebUI.verifyElementPresent(findTestObject('HomePage/assertListOfItemsInTypeahead_hp (2)'), 0)
