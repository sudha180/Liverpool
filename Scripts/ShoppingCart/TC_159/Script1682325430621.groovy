...
not_run: WebUI.verifyElementPresent(findTestObject('0CartPage/GiftTableDetails_Cart'), 0)

WebUI.verifyElementNotPresent(findTestObject('0CartPage/MoveToWishList_Cart'), 0)
