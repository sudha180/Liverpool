...
not_run: WebUI.click(findTestObject('0PDPPage/AddToCart_pdp (1)'))

not_run: WebUI.click(findTestObject('HomePage/Cart_header'))

not_run: WebUI.click(findTestObject('0CLPPage/CheckoutButton_Cart'))

WebUI.click(findTestObject('0OPCPage/ChangeAddress_Checkout'))

WebUI.click(findTestObject('0OPCPage/ClickNCollectAddressPopup_Checkout'))
