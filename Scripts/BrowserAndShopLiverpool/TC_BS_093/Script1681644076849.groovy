...
WebUI.callTestCase(findTestCase('CommonMethods/SearchForAProduct_search'), [('searchTerm') : '1030513316'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementNotPresent(findTestObject('PDPpage/Size2_PDP'), 0, FailureHandling.OPTIONAL)
