...
WebUI.verifyElementPresent(findTestObject('Object Repository/PDPPage/quantity_value_PDP'), 
    0)
...
WebUI.verifyElementText(findTestObject('Object Repository/PDPPage/quantity_value_PDP'), 
    '2')
