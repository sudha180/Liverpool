...
WebUI.click(findTestObject('0PLPPage/facetes/Facet_liverpool_PLP'))
...
WebUI.verifyElementNotPresent(findTestObject('0PLPPage/facetes/facet_selectedname_liverpool'), 0)
