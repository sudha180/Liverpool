...
WebUI.click(findTestObject('PLPPage/facetes/Facet_liverpool_PLP'))
...
WebUI.verifyElementNotPresent(findTestObject('PLPPage/facetes/facet_selectedname_liverpool'), 0)
