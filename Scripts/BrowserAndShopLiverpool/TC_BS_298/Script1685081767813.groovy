...
WebUI.verifyElementPresent(findTestObject('PDPPage/GID collection/SoftLine_product1_quantity_PDP'), 0)

WebUI.verifyElementPresent(findTestObject('PDPPage/GID collection/StickyBar_product2_quantity_PDP'), 0)
