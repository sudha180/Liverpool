...
WebUI.verifyElementPresent(findTestObject('PDPpage/gwpGiftPopup_pdp'), 0)

WebUI.click(findTestObject('PDPpage/secondGiftRadioButton_gwpPopup_pdp'), FailureHandling.STOP_ON_FAILURE)
